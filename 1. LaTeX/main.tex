...
de datos de entrenamiento $(X_i,Y_i)$, devuelve una función clasificadora $f$ sobre el espacio de entrada $X$ y el espacio de etiquetas $Y$ del que
provienen los datos.
\end{dfn}

En la práctica, dado un conjunto de datos que provienen de una cieta población, históricamente partimos de una familia de funciones que
...
primero definimos el espacio funcional $\mathcal{F}$, por ejemplo definido como una familia de funciones paramétricas (es decir, funciones que comparten
...
EJEMPLO DE CLASIFICADOR LINEAL CON PARAMETROS
