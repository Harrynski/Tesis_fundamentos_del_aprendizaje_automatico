...
\begin{proof}
    Sea $\epsilon > 0$. Sea el evento
    \[
        A_i = \{ \omega \in \Omega : |\xi_i(\omega)-C| > \epsilon\}.
    \]
...
Esto no es más que
\[
P\left( \bigcap_{n=1}^{\infty} \bigcup_{i\geq n}^{\infty} \{ \omega \in \Omega : |\xi_i(\omega)-C| > \epsilon\} \right) = 0.
\]
...
\[
P(A_i^c) = P(\{ \omega \in \Omega : |\xi_i(\omega)-C| < \epsilon\}) = 1
\]
...
\begin{proof}
    ...
    P^+\left(nl_0, \frac{\varepsilon}{2}\right) \leq P \left( \frac{1}{nl_0} \sum_{i=0}^{n-1} \log_2 \Delta^{\mathcal{S}}(\omega_{il_0+1}, \dots, \omega_{(i+1)l_0}) - c > \frac{\varepsilon}{2} \right).
    \end{equation}
    
    Definimos
    
    \[
    y = \frac{1}{nl_0} \sum_{i=0}^{n-1} \log_2 \Delta^{\mathcal{S}}(\omega_{il_0+1}, \dots, \omega_{(i+1)l_0})
    \]
    y observamos que
    \[
