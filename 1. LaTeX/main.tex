...
\begin{ej}
    Esperanzas de algunas variables aleatorias discretas:
    \begin{enumerate}
        \item Bernoulli: si $X\sim B(p)$ entonces $\mathbb{E}(X)=p$.
        \item Binomial: si $X\sim Bi(n,p)$ entonces $\mathbb{E}(X)=np$.   
    \end{enumerate}
\end{ej}
