...
que, no solamente no existe un clasificador universalmente bueno, sino que, \textbf{en promedio sobre todas las distribuciones
...
El Teorema No Free Lunch establece que, aunque existen reglas de clasificación que son universalmente 
...
probabilidad de error sea mayor que \(\ell(f_{Bayes}) + 1/4\) para todo \(n\). Tal afirmación 
