...
\begin{frame}{Clasificación: Planteo del Problema}
  ...
  \begin{center}
    \begin{minipage}{0.92\textwidth}
        ...
        Por ejemplo, podríamos querer clasificar un conjunto de imágenes de animales en base a los distintos tipos
        de animales que aparecen en ellas.
...
\begin{frame}{Clasificación: Suposiciones básicas}
  \begin{itemize}
    ...
    \item \textbf{Etiquetas no determinísticas:} modelamos $Y$ mediante probabilidades condicionales $P(Y=1\mid X=x)$. Esto se debe a que:
      \begin{itemize}
...
\begin{equation*}
    h_{\mathbf{w}, b}(\mathbf{x}) = \sgn(\mathbf{w}^T \mathbf{x} > 0)
\end{equation*}
...
\begin{frame}
  \begin{figure}
    \centering
    \subfloat{\includegraphics[width=0.27\textwidth]{images/perceptron 1.png}}\hspace{0.025\textwidth}
    \subfloat{\includegraphics[width=0.27\textwidth]{images/perceptron 2.png}}\\[0.2em]
    \subfloat{\includegraphics[width=0.27\textwidth]{images/perceptron 3.png}}\hspace{0.025\textwidth}
    \subfloat{\includegraphics[width=0.27\textwidth]{images/perceptron 4.png}}
  \end{figure}
\end{frame}
...
Nuestro interés será ver bajo qué
...
\begin{frame}{Subajuste y sobreajuste}
  \centering
  \includegraphics[width=0.92\textwidth,height=0.78\textheight,keepaspectratio]{images/over-underfitting.png}
\end{frame}
...
a medida que el número de elementos $n$ en el conjunto de entrenamiento crece, la función que se define cambia.\\
...
nuevo cambia la función que estamos tratando.\\
...
\begin{equation*}
P\left(\sup_{f \in \mathcal{F}} |\mathcal{R}(f) - \mathcal{R}_{\text{emp}}(f)| \geq \varepsilon \right) \leq m\left( 2 \exp(-2n\varepsilon^2) \right).
\end{equation*}
...
Ahora introducimos una nueva muestra \((X'_i, Y'_i)_{i=1,\dots,n}\), que también se extrae de manera
\textit{iid} de la misma distribución subyacente y que es independiente de la primera. \\
...
con eventos que dependen únicamente de las muestras observadas: Pudimos acotar el riesgo por el riesgo empírico.
\end{frame}
...
En el caso de clasificación binari el mayor cardinal posible para un conjunto de fragmentación
...
de funciones lineales.
  ...
  \begin{figure}[ht]
    ...
    \caption{Muestras en $\mathbb{R}^2$ de tres y cuatro puntos.}
\end{figure}
\end{frame}
