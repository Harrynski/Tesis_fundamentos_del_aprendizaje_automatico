...
\bigskip
\begin{alertblock}{ }
  Esto implica una generalización de la Ley de los Grandes Números,
a la que llamamos la \textbf{ley uniforme de los grandes números}.
\end{alertblock}
\end{frame}
...
% ==============================================================================
\begin{frame}{Reconciliar teoría y realidad}
    \begin{columns}[t]
        \begin{column}{0.31\textwidth}
            \begin{block}{1. Doble descenso}
                \small
                El riesgo de prueba alcanza un pico en el umbral de interpolación y luego vuelve a caer cuando aumenta la capacidad.
                \vspace{0.2cm}
                
                La sobreparametrización permite que la optimización elija \textbf{funciones más regulares} pese a la enorme capacidad disponible.
            \end{block}
        \end{column}
        \pause
        \begin{column}{0.31\textwidth}
            \begin{block}{2. Sesgo implícito}
                \small
                El espacio de hipótesis $\mathcal{F}$ es nominalmente enorme, pero la optimización (SGD) actúa como un \textbf{regularizador implícito}.
                \vspace{0.2cm}
                
                Selecciona soluciones en subregiones estrechas, estables o de norma mínima dentro del paisaje de pérdida.
            \end{block}
        \end{column}
        \pause
        \begin{column}{0.31\textwidth}
            \begin{block}{3. Geometría de los datos}
                \small
                Las cotas de peor caso son demasiado conservadoras. Los datos reales de texto e imágenes se concentran en \textbf{variedades} de alta dimensión.
                \vspace{0.2cm}
                
                La complejidad efectiva escala con la dimensión intrínseca de los datos, no con el número de parámetros.
            \end{block}
        \end{column}
    \end{columns}
    \pause
    ...
    \begin{beamercolorbox}[wd=\textwidth, rounded=true, center, sep=8pt]{lightbg}
        \textcolor{accentblue}{\textbf{Cambio conceptual:}} pasar de cotas uniformes globales sobre $\mathcal{F}$ a estabilidad algorítmica, geometría local y medidas dependientes de los datos.
    \end{beamercolorbox}
\end{frame}
