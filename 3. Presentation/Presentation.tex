...
\begin{frame}
  \centering
  \includegraphics[height=0.76\textheight,keepaspectratio]{images/frank_rosenblatt.jpg}

  \vspace{0.4em}
  {\scriptsize\textcolor{gray}{Frank Rosenblatt (Lic. 1950, Dr. 1956) trabajando en la computadora ``electronic profile analyzing'', precursora del perceptr\'on.}}
\end{frame}
