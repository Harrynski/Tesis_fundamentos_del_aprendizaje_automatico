...
\bigskip
\pause
         En el caso de los seres humanos, el aprendizaje es un proceso complejo que involucra aspectos cognitivos, emocionales y sociales.\\
...
\begin{frame}
  \IfFileExists{images/frames/frame_180.png}{%
    \includegraphics{images/frames/frame_180.png}%
  }{}
\end{frame}
...
Veremos que la MRE es consistente con el espacio fundional $\mathcal{F}$
