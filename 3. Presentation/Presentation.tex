...
\begin{frame}{EL Dilema Sesgo-Varianza}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \begin{block}{\small ¿Qué implica el tradeoff sesgo-varianza?}
        \small
        \begin{itemize}
...
\begin{frame}{Subajuste y sobreajuste}
  \begin{figure}
    \centering
    \subfloat[\scriptsize Subajuste]{\includegraphics[width=0.31\textwidth]{images/classification underfitting.png}}\hspace{0.02\textwidth}
    \pause
    \subfloat[\scriptsize Balanceado]{\includegraphics[width=0.31\textwidth]{images/classification balanced.png}}\hspace{0.02\textwidth}
    \pause
    \subfloat[\scriptsize Sobreajuste]{\includegraphics[width=0.31\textwidth]{images/classification overfitting.png}}
  \end{figure}
\end{frame}
